...
import { HealthcheckError } from 'src/common/errors/blockchain/healthcheck.error';
...
import { MULTICALL_ABI } from 'src/core/blockchain/web3-public/constants/multicall-abi';
import { MULTICALL_ADDRESSES } from 'src/core/blockchain/web3-public/constants/multicall-addresses';
import { BatchCall } from 'src/core/blockchain/web3-public/models/batch-call';
import { Call } from 'src/core/blockchain/web3-public/models/call';
import { ContractMulticallResponse } from 'src/core/blockchain/web3-public/models/contract-multicall-response';
import { MulticallResponse } from 'src/core/blockchain/web3-public/models/multicall-response';
import { RpcResponse } from 'src/core/blockchain/web3-public/models/rpc-response';
